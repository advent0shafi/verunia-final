...
export default function AiFotivoAward() {
    return (
        <section className="bg-[#171412] py-12 md:py-16 lg:py-20">
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 ">
                <div className="md:flex   items-center justify-center  gap-10 w-full">

                    <div className="font-instrument font-medium text-[20px] leading-[30px] tracking-normal text-[#F5F5F4] text-center  py-4 md:py-0  md:text-[28px] md:leading-[120%]">
